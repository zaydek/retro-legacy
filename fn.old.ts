...
function build(...codes: string[]): BuilderFunction {
	...
	format.bold = build
	format.dim = build
	format.underline = build
	format.black = build
	format.red = build
	format.green = build
	format.yellow = build
	format.blue = build
	format.magenta = build
	format.cyan = build
	format.white = build
	format.bgBlack = build
	format.bgRed = build
	format.bgGreen = build
	format.bgYellow = build
	format.bgBlue = build
	format.bgMagenta = build
	format.bgCyan = build
	format.bgWhite = build
